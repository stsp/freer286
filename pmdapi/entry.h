...
int host_reinit(unsigned ax, const void *entry, unsigned ss, unsigned esp);
int call_on_stack(int (*fn)(void), void *top);
extern char rsp16_tramp[];
extern uint32_t rsp16_cs_base;
extern uint16_t rsp16_sel;
